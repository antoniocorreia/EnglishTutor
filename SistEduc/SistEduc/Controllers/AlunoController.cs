...
namespace SistEduc.Controllers
{
    ...
    public class AlunoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Idade,Level,Username")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Idade,Level,Username")] Aluno aluno)
        {
            if (ModelState.IsValid)
            {
